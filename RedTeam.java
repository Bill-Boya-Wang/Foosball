...
public class RedTeam {
    ...
    public void paintTeam(Graphics g, ImageObserver IO) {
        ...
        if (Ball.touch == 15) g.drawImage(playerKick, 293, rowPos[1], 72, 47, IO);
        else                     g.drawImage(player, 320, rowPos[1], 45, 47, IO);
        if (Ball.touch == 16) g.drawImage(playerKick, 293, rowPos[1] + 150, 72, 47, IO);
        else                    g.drawImage(player, 320, rowPos[1] + 150, 45, 47, IO);
        if (Ball.touch == 17) g.drawImage(playerKick, 293, rowPos[1] + 300, 72, 47, IO);
        else                    g.drawImage(player, 320, rowPos[1] + 300, 45, 47, IO);

        if (Ball.touch == 18) g.drawImage(playerKick, 813, rowPos[2], 72, 47, IO);
        else                     g.drawImage(player, 840, rowPos[2], 45, 47, IO);
        if (Ball.touch == 19) g.drawImage(playerKick, 813, rowPos[2] + 250, 72, 47, IO);
        else                    g.drawImage(player, 840, rowPos[2] + 250, 45, 47, IO);

        if (Ball.touch == 20) g.drawImage(playerKick, 953, rowPos[3], 72, 47, IO);
        else                    g.drawImage(player, 980, rowPos[3], 45, 47, IO);
    }
