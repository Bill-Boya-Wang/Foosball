...
public class BlueTeam {
    ...
    public void paintTeam(Graphics g, ImageObserver IO) {
        ...
        g.drawImage(player, 700, rowPos[1], 45, 47, IO);
        g.drawImage(player, 700, rowPos[1] + 150, 45, 47, IO);
        g.drawImage(player, 700, rowPos[1] + 300, 45, 47, IO);
        g.drawImage(player, 200, rowPos[2], 45, 47, IO);
        g.drawImage(player, 200, rowPos[2] + 250, 45, 47, IO);
        g.drawImage(player, 90, rowPos[3], 45, 47, IO);
    }
